...
public class ExtentManager {
    ...
    private static String unixPath = System.getProperty("user.dir")+ "/TestReport";
    private static String unixReportFileLoc = unixPath + "/" + reportFileName;
    ...
    private static String getReportFileLocation (Platform platform) {
        ...
        switch (platform) {
            ...
            case WINDOWS:
                ...
                break;
            case LINUX:
                reportFileLocation = unixReportFileLoc;
                createReportPath(unixPath);
                System.out.println("ExtentReport Path for LINUX: " + unixReportFileLoc + "\n");
                break;
            default:
