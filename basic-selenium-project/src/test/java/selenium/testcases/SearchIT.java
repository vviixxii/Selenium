...
public class SearchIT extends SeleniumTestWrapper {
	...
	public void exampleTestForUserSearch() {
		...
		System.out.println("******** exampleTestForUserSearch");
		System.out.println("******** " + this.getClass().getSimpleName() + " -> startPage: " + startPage.toString());
		search.searchFor(search.getSearchString());
		System.out.println("******** search.getSearchString: " + search.getSearchString());
		System.out.println("******** searchResultPage.getInputValue: " + searchResultPage.getInputValue());
