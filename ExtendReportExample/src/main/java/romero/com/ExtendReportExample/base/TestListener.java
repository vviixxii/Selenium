package romero.com.ExtendReportExample.base;
...
public class TestListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String testClassName = result.getInstanceName(); // getTestClassName(result.getInstanceName()).trim();
		long timeStamp = new Date().getTime(); // Util.getCurrentTimeStamp(); // get timestamp
	...
	public String getCurrentTimeStamp() {
		//Date date = new Date();
		//Timestamp time = new Timestamp(date.getTime(), null); 
//		
